...
module Appium
  module Ios
    ...
    def s_text value
      ...
      xpath(xpath_visible_contains('UIAStaticText', value))
    end

    def s_texts value
      xpaths(xpath_visible_contains('UIAStaticText', value))
    end
    ...
    def s_text_exact value
      xpath xpath_visible_exact 'UIAStaticText', value
    end
    ...
    def s_texts_exact value
      xpaths xpath_visible_exact 'UIAStaticText', value
    end
  end # module Common
end # module Appium